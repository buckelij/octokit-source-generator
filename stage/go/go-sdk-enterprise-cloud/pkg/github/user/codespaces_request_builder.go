...
func (m *CodespacesPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    if m.GetCodespacesPostRequestBodyMember1() != nil {
        return m.GetCodespacesPostRequestBodyMember1().GetFieldDeserializers()
    } else if m.GetCodespacesPostRequestBodyMember2() != nil {
        return m.GetCodespacesPostRequestBodyMember2().GetFieldDeserializers()
    }
...
// ByCodespace_name gets an item from the github.com/octokit/go-sdk-enterprise-cloud/pkg/github.user.codespaces.item collection
...
// 
// [API method documentation]: https://docs.github.com/enterprise-cloud@latest//rest/codespaces/codespaces#list-codespaces-for-the-authenticated-user
...
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/enterprise-cloud@latest//rest/codespaces/codespaces#create-a-codespace-for-the-authenticated-user
