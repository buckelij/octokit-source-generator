...
func (m *SecretScanningLocation_SecretScanningLocation_details) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    if m.GetSecretScanningLocationCommit() != nil {
        return m.GetSecretScanningLocationCommit().GetFieldDeserializers()
    } else if m.GetSecretScanningLocationDiscussionBody() != nil {
        return m.GetSecretScanningLocationDiscussionBody().GetFieldDeserializers()
    } else if m.GetSecretScanningLocationDiscussionComment() != nil {
        return m.GetSecretScanningLocationDiscussionComment().GetFieldDeserializers()
    } else if m.GetSecretScanningLocationDiscussionTitle() != nil {
        return m.GetSecretScanningLocationDiscussionTitle().GetFieldDeserializers()
    } else if m.GetSecretScanningLocationIssueBody() != nil {
        return m.GetSecretScanningLocationIssueBody().GetFieldDeserializers()
    } else if m.GetSecretScanningLocationIssueComment() != nil {
        return m.GetSecretScanningLocationIssueComment().GetFieldDeserializers()
    } else if m.GetSecretScanningLocationIssueTitle() != nil {
        return m.GetSecretScanningLocationIssueTitle().GetFieldDeserializers()
    } else if m.GetSecretScanningLocationPullRequestBody() != nil {
        return m.GetSecretScanningLocationPullRequestBody().GetFieldDeserializers()
    } else if m.GetSecretScanningLocationPullRequestComment() != nil {
        return m.GetSecretScanningLocationPullRequestComment().GetFieldDeserializers()
    } else if m.GetSecretScanningLocationPullRequestReview() != nil {
        return m.GetSecretScanningLocationPullRequestReview().GetFieldDeserializers()
    } else if m.GetSecretScanningLocationPullRequestReviewComment() != nil {
        return m.GetSecretScanningLocationPullRequestReviewComment().GetFieldDeserializers()
    } else if m.GetSecretScanningLocationPullRequestTitle() != nil {
        return m.GetSecretScanningLocationPullRequestTitle().GetFieldDeserializers()
    } else if m.GetSecretScanningLocationWikiCommit() != nil {
        return m.GetSecretScanningLocationWikiCommit().GetFieldDeserializers()
    }
