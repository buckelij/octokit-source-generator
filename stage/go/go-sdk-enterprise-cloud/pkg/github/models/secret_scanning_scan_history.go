...
type SecretScanningScanHistory struct {
    ...
    custom_pattern_backfill_scans []SecretScanningScanHistory_custom_pattern_backfill_scansable
...
// returns a []SecretScanningScanHistory_custom_pattern_backfill_scansable when successful
func (m *SecretScanningScanHistory) GetCustomPatternBackfillScans()([]SecretScanningScanHistory_custom_pattern_backfill_scansable) {
...
func (m *SecretScanningScanHistory) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["custom_pattern_backfill_scans"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(CreateSecretScanningScanHistory_custom_pattern_backfill_scansFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]SecretScanningScanHistory_custom_pattern_backfill_scansable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(SecretScanningScanHistory_custom_pattern_backfill_scansable)
                }
            }
...
func (m *SecretScanningScanHistory) SetCustomPatternBackfillScans(value []SecretScanningScanHistory_custom_pattern_backfill_scansable)() {
...
type SecretScanningScanHistoryable interface {
    ...
    GetCustomPatternBackfillScans()([]SecretScanningScanHistory_custom_pattern_backfill_scansable)
    ...
    SetCustomPatternBackfillScans(value []SecretScanningScanHistory_custom_pattern_backfill_scansable)()
