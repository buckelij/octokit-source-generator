...
func (m *LabelsPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    if m.GetItemItemIssuesItemLabelsPostRequestBodyMember1() != nil {
        return m.GetItemItemIssuesItemLabelsPostRequestBodyMember1().GetFieldDeserializers()
    } else if m.GetItemItemIssuesItemLabelsPostRequestBodyMember2() != nil {
        return m.GetItemItemIssuesItemLabelsPostRequestBodyMember2().GetFieldDeserializers()
    }
...
func (m *LabelsPutRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    if m.GetItemItemIssuesItemLabelsPutRequestBodyMember1() != nil {
        return m.GetItemItemIssuesItemLabelsPutRequestBodyMember1().GetFieldDeserializers()
    } else if m.GetItemItemIssuesItemLabelsPutRequestBodyMember2() != nil {
        return m.GetItemItemIssuesItemLabelsPutRequestBodyMember2().GetFieldDeserializers()
    }
    return make(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error))
}
// GetIsComposedType determines if the current object is a wrapper around a composed type
...
// ByName gets an item from the github.com/octokit/go-sdk-enterprise-cloud/pkg/github.repos.item.item.issues.item.labels.item collection
...
// 
// [API method documentation]: https://docs.github.com/enterprise-cloud@latest//rest/issues/labels#remove-all-labels-from-an-issue
...
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/enterprise-cloud@latest//rest/issues/labels#list-labels-for-an-issue
...
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/enterprise-cloud@latest//rest/issues/labels#add-labels-to-an-issue
...
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/enterprise-cloud@latest//rest/issues/labels#set-labels-for-an-issue
