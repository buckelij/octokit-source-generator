...
func (m *CheckRunsPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    if m.GetItemItemCheckRunsPostRequestBodyMember1() != nil {
        return m.GetItemItemCheckRunsPostRequestBodyMember1().GetFieldDeserializers()
    } else if m.GetItemItemCheckRunsPostRequestBodyMember2() != nil {
        return m.GetItemItemCheckRunsPostRequestBodyMember2().GetFieldDeserializers()
    }
...
// ByCheck_run_id gets an item from the github.com/octokit/go-sdk-enterprise-cloud/pkg/github.repos.item.item.checkRuns.item collection
...
// 
// [API method documentation]: https://docs.github.com/enterprise-cloud@latest//rest/checks/runs#create-a-check-run
func (m *ItemItemCheckRunsRequestBuilder) Post(ctx context.Context, body CheckRunsPostRequestBodyable, requestConfiguration *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestConfiguration[i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.DefaultQueryParameters])(i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.CheckRunable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.CreateCheckRunFromDiscriminatorValue, nil)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.CheckRunable), nil
}
