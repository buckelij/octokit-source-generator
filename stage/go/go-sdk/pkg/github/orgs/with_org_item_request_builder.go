...
// CredentialAuthorizations the credentialAuthorizations property
// returns a *ItemCredentialAuthorizationsRequestBuilder when successful
func (m *WithOrgItemRequestBuilder) CredentialAuthorizations()(*ItemCredentialAuthorizationsRequestBuilder) {
    return NewItemCredentialAuthorizationsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
// Custom_roles the custom_roles property
// returns a *ItemCustom_rolesRequestBuilder when successful
func (m *WithOrgItemRequestBuilder) Custom_roles()(*ItemCustom_rolesRequestBuilder) {
...
// 
// [API method documentation]: https://docs.github.com/enterprise-cloud@latest//rest/orgs/orgs#delete-an-organization
...
// Fine_grained_permissions the fine_grained_permissions property
// returns a *ItemFine_grained_permissionsRequestBuilder when successful
func (m *WithOrgItemRequestBuilder) Fine_grained_permissions()(*ItemFine_grained_permissionsRequestBuilder) {
    return NewItemFine_grained_permissionsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/enterprise-cloud@latest//rest/orgs/orgs#get-an-organization
...
// returns a *ItemTeamSyncRequestBuilder when successful
func (m *WithOrgItemRequestBuilder) TeamSync()(*ItemTeamSyncRequestBuilder) {
    return NewItemTeamSyncRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
// ToPatchRequestInformation > [!WARNING]> **Closing down notice:** GitHub Enterprise Cloud will replace and discontinue `members_allowed_repository_creation_type` in favor of more granular permissions. The new input parameters are `members_can_create_public_repositories`, `members_can_create_private_repositories` for all organizations and `members_can_create_internal_repositories` for organizations associated with an enterprise account using GitHub Enterprise Cloud or GitHub Enterprise Server 2.20+. For more information, see the [blog post](https://developer.github.com/changes/2019-12-03-internal-visibility-changes).> [!WARNING]> **Closing down notice:** Code security product enablement for new repositories through the organization API is closing down. Please use [code security configurations](https://docs.github.com/enterprise-cloud@latest//rest/code-security/configurations#set-a-code-security-configuration-as-a-default-for-an-organization) to set defaults instead. For more information on setting a default security configuration, see the [changelog](https://github.blog/changelog/2024-07-09-sunsetting-security-settings-defaults-parameters-in-the-organizations-rest-api/).Updates the organization's profile and member privileges.The authenticated user must be an organization owner to use this endpoint.OAuth app tokens and personal access tokens (classic) need the `admin:org` or `repo` scope to use this endpoint.
// returns a *RequestInformation when successful
