...
// ItemTeamItemCopilotMetricsRequestBuilder builds and executes requests for operations under \orgs\{org}\team\{team_slug}\copilot\metrics
...
func NewItemTeamItemCopilotMetricsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemTeamItemCopilotMetricsRequestBuilder) {
    m := &ItemTeamItemCopilotMetricsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/orgs/{org}/team/{team_slug}/copilot/metrics{?page*,per_page*,since*,until*}", pathParameters),
    }
    return m
}
...
// 
// [API method documentation]: https://docs.github.com/enterprise-cloud@latest//rest/copilot/copilot-metrics#get-copilot-metrics-for-a-team
