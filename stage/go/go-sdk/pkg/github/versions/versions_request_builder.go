...
// Get get all supported GitHub Enterprise Cloud API versions.
// returns a []DateOnly when successful
// returns a BasicError error when the service returns a 404 status code
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/enterprise-cloud@latest//rest/meta/meta#get-all-api-versions
...
// ToGetRequestInformation get all supported GitHub Enterprise Cloud API versions.
