...
// ItemRulesetsWithRuleset_ItemRequestBuilder builds and executes requests for operations under \enterprises\{enterprise}\rulesets\{ruleset_id}
...
func NewItemRulesetsWithRuleset_ItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRulesetsWithRuleset_ItemRequestBuilder) {
    m := &ItemRulesetsWithRuleset_ItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/enterprises/{enterprise}/rulesets/{ruleset_id}", pathParameters),
    }
    return m
}
...
// Delete delete a ruleset for an enterprise.
// returns a BasicError error when the service returns a 404 status code
// returns a BasicError error when the service returns a 500 status code
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/enterprise-cloud@latest//rest/enterprise-admin/rules#delete-an-enterprise-repository-ruleset
...
// Get get a repository ruleset for an enterprise.**Note:** To prevent leaking sensitive information, the `bypass_actors` property is only returned if the usermaking the API request has write access to the ruleset.
// returns a RepositoryRulesetable when successful
// returns a BasicError error when the service returns a 404 status code
// returns a BasicError error when the service returns a 500 status code
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/enterprise-cloud@latest//rest/enterprise-admin/rules#get-an-enterprise-repository-ruleset
...
// Put update a ruleset for an enterprise.
// returns a RepositoryRulesetable when successful
// returns a BasicError error when the service returns a 404 status code
// returns a BasicError error when the service returns a 500 status code
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/enterprise-cloud@latest//rest/enterprise-admin/rules#update-an-enterprise-repository-ruleset
...
// ToDeleteRequestInformation delete a ruleset for an enterprise.
...
// ToGetRequestInformation get a repository ruleset for an enterprise.**Note:** To prevent leaking sensitive information, the `bypass_actors` property is only returned if the usermaking the API request has write access to the ruleset.
// returns a *RequestInformation when successful
...
// ToPutRequestInformation update a ruleset for an enterprise.
// returns a *RequestInformation when successful
