...
// ItemActionsHostedRunnersWithHosted_runner_ItemRequestBuilder builds and executes requests for operations under \enterprises\{enterprise}\actions\hosted-runners\{hosted_runner_id}
...
func NewItemActionsHostedRunnersWithHosted_runner_ItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemActionsHostedRunnersWithHosted_runner_ItemRequestBuilder) {
    m := &ItemActionsHostedRunnersWithHosted_runner_ItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/enterprises/{enterprise}/actions/hosted-runners/{hosted_runner_id}", pathParameters),
    }
    return m
}
...
// Delete deletes a GitHub-hosted runner for an enterprise.
// returns a ActionsHostedRunnerable when successful
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/enterprise-cloud@latest//rest/actions/hosted-runners#delete-a-github-hosted-runner-for-an-enterprise
...
// Get gets a GitHub-hosted runner configured in an enterprise.OAuth app tokens and personal access tokens (classic) need the `manage_runners:enterprise` scope to use this endpoint.
// returns a ActionsHostedRunnerable when successful
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/enterprise-cloud@latest//rest/actions/hosted-runners#get-a-github-hosted-runner-for-an-enterprise
...
// Patch updates a GitHub-hosted runner for an enterprise.OAuth app tokens and personal access tokens (classic) need the `manage_runners:enterprise` scope to use this endpoint.
// returns a ActionsHostedRunnerable when successful
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/enterprise-cloud@latest//rest/actions/hosted-runners#update-a-github-hosted-runner-for-an-enterprise
...
// ToDeleteRequestInformation deletes a GitHub-hosted runner for an enterprise.
...
// ToGetRequestInformation gets a GitHub-hosted runner configured in an enterprise.OAuth app tokens and personal access tokens (classic) need the `manage_runners:enterprise` scope to use this endpoint.
// returns a *RequestInformation when successful
...
// ToPatchRequestInformation updates a GitHub-hosted runner for an enterprise.OAuth app tokens and personal access tokens (classic) need the `manage_runners:enterprise` scope to use this endpoint.
// returns a *RequestInformation when successful
