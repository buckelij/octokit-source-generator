...
type ItemActionsPermissionsPutRequestBody struct {
    ...
    enabled_organizations *i59ea7d99994c6a4bb9ef742ed717844297d055c7fd3742131406eea67a6404b6.EnabledOrganizations
}
...
func (m *ItemActionsPermissionsPutRequestBody) GetEnabledOrganizations()(*i59ea7d99994c6a4bb9ef742ed717844297d055c7fd3742131406eea67a6404b6.EnabledOrganizations) {
...
func (m *ItemActionsPermissionsPutRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["enabled_organizations"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetEnumValue(i59ea7d99994c6a4bb9ef742ed717844297d055c7fd3742131406eea67a6404b6.ParseEnabledOrganizations)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetEnabledOrganizations(val.(*i59ea7d99994c6a4bb9ef742ed717844297d055c7fd3742131406eea67a6404b6.EnabledOrganizations))
        }
        return nil
    }
    return res
...
func (m *ItemActionsPermissionsPutRequestBody) SetEnabledOrganizations(value *i59ea7d99994c6a4bb9ef742ed717844297d055c7fd3742131406eea67a6404b6.EnabledOrganizations)() {
...
type ItemActionsPermissionsPutRequestBodyable interface {
    ...
    GetEnabledOrganizations()(*i59ea7d99994c6a4bb9ef742ed717844297d055c7fd3742131406eea67a6404b6.EnabledOrganizations)
    SetAllowedActions(value *i59ea7d99994c6a4bb9ef742ed717844297d055c7fd3742131406eea67a6404b6.AllowedActions)()
    SetEnabledOrganizations(value *i59ea7d99994c6a4bb9ef742ed717844297d055c7fd3742131406eea67a6404b6.EnabledOrganizations)()
}
