...
type ItemRulesetsItemWithRuleset_PutRequestBody struct {
    ...
    conditions i59ea7d99994c6a4bb9ef742ed717844297d055c7fd3742131406eea67a6404b6.EnterpriseRulesetConditionsable
...
func (m *ItemRulesetsItemWithRuleset_PutRequestBody) GetConditions()(i59ea7d99994c6a4bb9ef742ed717844297d055c7fd3742131406eea67a6404b6.EnterpriseRulesetConditionsable) {
    return m.conditions
}
...
func (m *ItemRulesetsItemWithRuleset_PutRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["conditions"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(i59ea7d99994c6a4bb9ef742ed717844297d055c7fd3742131406eea67a6404b6.CreateEnterpriseRulesetConditionsFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetConditions(val.(i59ea7d99994c6a4bb9ef742ed717844297d055c7fd3742131406eea67a6404b6.EnterpriseRulesetConditionsable))
        }
        return nil
    }
...
func (m *ItemRulesetsItemWithRuleset_PutRequestBody) SetConditions(value i59ea7d99994c6a4bb9ef742ed717844297d055c7fd3742131406eea67a6404b6.EnterpriseRulesetConditionsable)() {
    m.conditions = value
}
...
type ItemRulesetsItemWithRuleset_PutRequestBodyable interface {
    ...
    GetConditions()(i59ea7d99994c6a4bb9ef742ed717844297d055c7fd3742131406eea67a6404b6.EnterpriseRulesetConditionsable)
    ...
    SetConditions(value i59ea7d99994c6a4bb9ef742ed717844297d055c7fd3742131406eea67a6404b6.EnterpriseRulesetConditionsable)()
