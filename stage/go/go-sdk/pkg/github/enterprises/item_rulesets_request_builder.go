...
// ItemRulesetsRequestBuilder builds and executes requests for operations under \enterprises\{enterprise}\rulesets
type ItemRulesetsRequestBuilder struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// ByRuleset_id gets an item from the github.com/octokit/go-sdk/pkg/github.enterprises.item.rulesets.item collection
...
func NewItemRulesetsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRulesetsRequestBuilder) {
    m := &ItemRulesetsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/enterprises/{enterprise}/rulesets", pathParameters),
    }
    return m
}
...
// Post create a repository ruleset for an enterprise.
// returns a RepositoryRulesetable when successful
// returns a BasicError error when the service returns a 404 status code
// returns a BasicError error when the service returns a 500 status code
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/enterprise-cloud@latest//rest/enterprise-admin/rules#create-an-enterprise-repository-ruleset
...
// ToPostRequestInformation create a repository ruleset for an enterprise.
